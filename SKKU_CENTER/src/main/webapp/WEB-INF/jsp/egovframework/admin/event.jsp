                ...
                <caption>공지사항 목록</caption>
                	...
                	<thead>
                    	<tr>
                            ...
                            <th scope="col" class="etc">현황</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr class="on">
                            <td class="num"><span class="notice">공지</span></td>
                            <td class="subject"><span class="tag">센터 |</span><a href="./view.jsp">대학교육혁신센터(CIHE)</a></td>
                            <td class="date">2015-03-31</td>
                            <td class="hit">20</td>
                            <td class="etc"><a href="/" class="btnBlues">신청하기</a></td>
                        </tr>
                        <tr>
                            <td class="num">1</td>
                            <td class="subject"><span class="tag">대학특성화 |</span><a href="./view.jsp">Creative Design Studio CI Office(인사캠)</a></td>
                            <td class="date">2015-03-31</td>
                            <td class="hit">20</td>
                            <td class="etc"><a href="/" class="btnGrays">완료</a></td>
                        </tr>
                        <tr>
                            <td class="num">1</td>
                            <td class="subject"><span class="tag">대학연구 |</span><a href="./view.jsp">공지사항입니다.</a></td>
                            <td class="date">2015-03-31</td>
                            <td class="hit">20</td>
                            <td class="etc"><a href="/" class="btnGrays">완료</a></td>
                        </tr>
