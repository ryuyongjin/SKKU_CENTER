...
<div class="lnb">
    ...
    <ul>
        <li class="sn1 none"><a href="#none">소개</a></li>
        <li class="snFirst1 sub"><a href="/cschool/about01.do">참여학과</a></li>
        <li class="snFirst2 sub"><a href="/cschool/about02.do">인재상</a></li>
        
        <li class="sn2 none"><a href="#none">교육과정</a></li>
        <li class="snSecond1 sub"><a href="/cschool/course01.do">로드맵</a></li>
        <li class="snSecond2 sub"><a href="/cschool/course02.do">교과목</a></li>
        <li class="snSecond3 sub"><a href="/cschool/course03.do">비교과 프로그램</a></li>
